...
const SellingSection = () => {
    ...
    return (
        <div className="hero bg-gray-900 text-zinc-50 w-full md:w-4/5 mx-auto rounded-none md:rounded-md border-y-2 md:border-2 border-neutral mb-10">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='text-center lg:text-left'>
                    ...
                    <Link to='/sell' className="btn hover:text-zinc-50 bg-zinc-50 text-gray-900">Start Selling</Link>
                </div>
            </div>
        </div>
    );
