    ...
    return (
        <div className='grid grid-cols-1'>
            ...
            <div className="card bg-base-100 shadow-xl m-4">
                <div className="card-body bg-gray-900 text-zinc-50">
                    <h1 className="card-title text-2xl mb-5"># What is the difference between SQL & NoSQL?</h1>
                    <p className="font-semibold text-justify">
                        <span className='font-bolder bg-slate-200 text-gray-900 px-2 py-1 rounded'>SQL</span> : SQL databases are primarily called as Relational Databases (RDBMS). These databases defines and manipulates data based on structured query language (SQL). These databases have fixed or static or predefined schema. These databases are not suited for hierarchical data storage. These databases are best suited for complex queries. They are 'Vertically' Scalable. They follows ACID property. <br />
                        <br />
                        <span className='font-bolder bg-slate-200 text-gray-900 px-2 py-1 rounded'>Examples</span> : MySQL, PostgreSQL, Oracle, MS-SQL Server, etc.
                    </p>
                    <div className="divider"></div>
                    <p className="font-semibold text-justify">
                        <span className='font-bolder bg-slate-200 text-gray-900 px-2 py-1 rounded'>NoSQL</span> : NoSQL database are primarily called as non-relational or distributed database. They have dynamic schema. These databases are best suited for hierarchical data storage. These databases are not so good for complex queries. They are 'Horizontally' scalable. They follows CAP(consistency, availability, partition tolerance) property. <br />
                        <br />
                        <span className='font-bolder bg-slate-200 text-gray-900 px-2 py-1 rounded'>Examples</span> : MongoDB, GraphQL, HBase, Neo4j, Cassandra, etc
                    </p>
                </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-xl m-4">
                <div className="card-body bg-gray-900 text-zinc-50">
                    ...
                    <p className="font-semibold text-justify">
                        <span className='font-bolder bg-slate-200 text-gray-900 px-2 py-1 rounded'>JWT</span> : JSON web token(JWT) is a JSON Object which is used to securely transfer information over the web (between two parties). It can be used for an authentication system and can also be used for information exchange.
                    </p>
                    <div className="divider"></div>
                    <p className="font-semibold text-justify">
                        <span className='font-bolder bg-slate-200 text-gray-900 px-2 py-1 rounded'>Functionality</span> : JWT token is mainly composed of header, payload, and signature. These three parts are separated by dots(.). JWT defines the structure of information we are sending from one party to the another, and it comes in two forms – Serialized, Deserialized. The Serialized approach is mainly used to transfer the data through the network with each request and response. While the deserialized approach is used to read and write data to the web token. <br />
            ...
            <div className="card bg-base-100 shadow-xl m-4">
                <div className="card-body bg-gray-900 text-zinc-50">
                    ...
                    <p className="font-semibold text-justify">
                        <span className='font-bolder bg-slate-200 text-gray-900 px-2 py-1 rounded'>Handling Multiple Requests</span> : We know NodeJS application is single-threaded. But the fact is, NodeJS event loops are only single-threaded. The entire NodeJS architecture is not single-threaded. <br />
