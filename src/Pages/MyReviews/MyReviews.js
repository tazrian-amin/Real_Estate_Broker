...
const MyReviews = () => {
    ...
    return (
        <>
            {
                reviews.length === 0 ?
                    <div className="hero min-h-screen bg-base-200 w-full mx-auto" style={{ backgroundImage: `url("https://images.unsplash.com/photo-1510936111840-65e151ad71bb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=890&q=80")` }}>
